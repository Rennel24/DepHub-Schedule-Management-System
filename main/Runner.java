...
public class Runner {
    ...
    try {
        ...
        admin.addSchedule("S104a", prog4, "IT-2101", prof4, "Monday", time4a, room4a);
        ...
        admin.addSchedule("S105a", prog5, "IT-2101", prof5, "Tuesday", time5a, room5a);
...
private void runStudentMenu() {
 ...
 private void addSchedule() {
    try {
     ...
     private void updateSchedule() {
            try {
                ...
                // Delegate to Admin's method (it handles conflicts + no-change)
    ...
    private void assignScheduleToProfessor() {
        ...
        // Find the schedule in the admin's master list
        ...
        // Assign the schedule to the professor
      ...
      private void enrollScheduleForStudent() {
            try {
                ...
                if (sched != null) {
                    student.enrollSchedule(sched);  // ← This line calls your method!
                } else {
